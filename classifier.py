...
class CLASSIFIER:
    # train_Y is interger 
    def __init__(self, opt, _train_X, _train_Y,  _nclass, _input_dim, _cuda, _lr=0.001, _beta1=0.5, _nepoch=20, _batch_size=100, pretrain_classifer=''):
        ...
        if pretrain_classifer == '':
            ...
            pretrain_classifier = opt.pretrain_classifier
